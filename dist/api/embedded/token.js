...
class TokenApi {
    ...
    async mint(tokenStandard, amount, receiveAddress) {
        ...
        return account_block_template_1.AccountBlockTemplate.callContract(address_1.tokenAddress, token_standard_1.znnZts, ethers_1.ethers.BigNumber.from("0"), encodedFunction);
    }
    ...
    async updateToken(tokenStandard, owner, isMintable, isBurnable) {
        let encodedFunction = definitions_1.Definitions.token.encodeFunction("UpdateToken", [
            tokenStandard,
            owner,
            isMintable,
            isBurnable,
