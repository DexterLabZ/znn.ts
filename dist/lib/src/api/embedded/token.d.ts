...
export declare class TokenApi {
    ...
    issueToken(tokenName: string, tokenSymbol: string, tokenDomain: string, totalSupply: BigNumber, maxSupply: BigNumber, decimals: number, mintable: boolean, burnable: boolean, utility: boolean): Promise<AccountBlockTemplate>;
    mint(tokenStandard: TokenStandard, amount: BigNumber, receiveAddress: Address): Promise<AccountBlockTemplate>;
    burnToken(tokenStandard: TokenStandard, amount: BigNumber): Promise<AccountBlockTemplate>;
