...
// Pillar
exports.pillarRegisterZnnAmount = 15000 * nom_constants_1.oneZnn;
exports.pillarRegisterQsrAmount = 150000 * nom_constants_1.oneQsr;
exports.pillarNameMaxLength = 40;
exports.pillarNameRegExp = RegExp('^([a-zA-Z0-9]+[-._]?)*[a-zA-Z0-9]$');
// Sentinel
exports.sentinelRegisterZnnAmount = 5000 * nom_constants_1.oneZnn;
exports.sentinelRegisterQsrAmount = 50000 * nom_constants_1.oneQsr;
// Staking
exports.stakeTimeUnitSec = 30 * 24 * 60 * 60;
exports.stakeTimeMaxSec = 12 * exports.stakeTimeUnitSec;
exports.stakeMinZnnAmount = nom_constants_1.oneZnn;
exports.stakeUnitDurationName = 'month';
// Token
exports.tokenZtsIssueFeeInZnn = nom_constants_1.oneZnn;
