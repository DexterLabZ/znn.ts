...
class AccountBlock extends account_block_template_1.AccountBlockTemplate {
    ...
    static fromJson(json) {
        ...
        return new AccountBlock(accountBlockTemplate.version, accountBlockTemplate.chainIdentifier, accountBlockTemplate.blockType, accountBlockTemplate.hash, accountBlockTemplate.previousHash, accountBlockTemplate.height, accountBlockTemplate.momentumAcknowledged, accountBlockTemplate.address, accountBlockTemplate.toAddress, accountBlockTemplate.amount, accountBlockTemplate.tokenStandard, accountBlockTemplate.fromBlockHash, accountBlockTemplate.data, accountBlockTemplate.fusedPlasma, accountBlockTemplate.difficulty, accountBlockTemplate.nonce, accountBlockTemplate.publicKey, accountBlockTemplate.signature, json['token'] ? token_1.Token.fromJson(json['token']) : undefined, json['descendantBlocks'] ? json['descendantBlocks'].map((block) => AccountBlock.fromJson(block)) : [], json['basePlasma'], json['usedPlasma'], json['changesHash'] ? hash_1.Hash.parse(json['changesHash']) : hash_1.emptyHash, json['confirmationDetail'] ? AccountBlockConfirmationDetail.fromJson(json['confirmationDetail']) : undefined, json['pairedAccountBlock'] ? AccountBlock.fromJson(json['pairedAccountBlock']) : undefined);
    }
    toJson() {
