...
class PillarEpochHistory {
    ...
    static fromJson(json) {
        return new PillarEpochHistory(json.name, json.epoch, json.giveBlockRewardPercentage, json.giveDelegateRewardPercentage, json.producedBlockNum, json.expectedBlockNum, json.weight);
    }
    toJson() {
        return {
            name: this.name,
