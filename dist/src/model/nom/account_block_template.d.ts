...
export declare class AccountBlockTemplate {
    ...
    static send(toAddress: Address, tokenStandard: TokenStandard, amount: number | string): AccountBlockTemplate;
    static callContract(address: Address, tokenStandard: TokenStandard, amount: number | string, data: Buffer): AccountBlockTemplate;
    toString(): string;
}
