  ...
  static fromJson(json: {[key: string]: any} ): AccountInfo {
    ...
    return new AccountInfo(
      ...
      (json['accountHeight']! > 0) 
        ? Object.keys(json['balanceInfoMap'])?.map((entry: string) => BalanceInfoListItem.fromJson(json['balanceInfoMap'][entry]))
        : [],
      (json['accountHeight']! > 0) 
      ? mapObject(json['balanceInfoMap'], BalanceInfoListItem.fromJson)
      : []
    );
  }
