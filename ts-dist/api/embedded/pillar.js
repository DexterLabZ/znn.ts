...
class PillarApi {
    ...
    // ToDo: Add response validation
    name, producerAddress, rewardAddress, giveBlockRewardPercentage = 0, giveDelegateRewardPercentage = 100) {
        return account_block_template_1.AccountBlockTemplate.callContract(address_1.pillarAddress, token_standard_1.znnZts, ethers_1.ethers.BigNumber.from("0"), definitions_1.Definitions.pillar.encodeFunction("UpdatePillar", [
            name,
            producerAddress,
            rewardAddress,
            giveBlockRewardPercentage,
    ...
    revoke(name) {
        // ToDo: Add response validation
        return account_block_template_1.AccountBlockTemplate.callContract(address_1.pillarAddress, token_standard_1.znnZts, ethers_1.ethers.BigNumber.from("0"), definitions_1.Definitions.pillar.encodeFunction("Revoke", [name]));
    }
    delegate(name) {
        // ToDo: Add response validation
        return account_block_template_1.AccountBlockTemplate.callContract(address_1.pillarAddress, token_standard_1.znnZts, ethers_1.ethers.BigNumber.from("0"), definitions_1.Definitions.pillar.encodeFunction("Delegate", [name]));
    }
    undelegate() {
        // ToDo: Add response validation
        return account_block_template_1.AccountBlockTemplate.callContract(address_1.pillarAddress, token_standard_1.znnZts, ethers_1.ethers.BigNumber.from("0"), definitions_1.Definitions.pillar.encodeFunction("Undelegate", []));
    }
    // Common contract methods
    collectReward() {
        // ToDo: Add response validation
        return account_block_template_1.AccountBlockTemplate.callContract(address_1.pillarAddress, token_standard_1.znnZts, ethers_1.ethers.BigNumber.from("0"), definitions_1.Definitions.common.encodeFunction("CollectReward", []));
    }
    depositQsr(amount) {
        // ToDo: Add response validation
    ...
    withdrawQsr() {
        // ToDo: Add response validation
        return account_block_template_1.AccountBlockTemplate.callContract(address_1.pillarAddress, token_standard_1.znnZts, ethers_1.ethers.BigNumber.from("0"), definitions_1.Definitions.common.encodeFunction("WithdrawQsr", []));
    }
}
