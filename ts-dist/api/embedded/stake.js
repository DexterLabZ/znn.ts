...
class StakeApi {
    ...
    cancel(id) {
        // ToDo: Add response validation
        return account_block_template_1.AccountBlockTemplate.callContract(address_1.stakeAddress, token_standard_1.znnZts, ethers_1.ethers.BigNumber.from("0"), definitions_1.Definitions.stake.encodeFunction("Cancel", [id.getBytes()]));
    }
    // Common contract methods
    collectReward() {
        // ToDo: Add response validation
        return account_block_template_1.AccountBlockTemplate.callContract(address_1.stakeAddress, token_standard_1.znnZts, ethers_1.ethers.BigNumber.from("0"), definitions_1.Definitions.common.encodeFunction("CollectReward", []));
    }
}
