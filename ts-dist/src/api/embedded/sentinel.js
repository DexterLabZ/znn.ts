...
class SentinelApi {
    ...
    async revoke() {
        // ToDo: Add response validation!
        return account_block_template_1.AccountBlockTemplate.callContract(address_1.sentinelAddress, token_standard_1.znnZts, ethers_1.ethers.BigNumber.from("0"), definitions_1.Definitions.sentinel.encodeFunction("Revoke", []));
    }
    // Common contract methods
    async collectRewards() {
        // ToDo: Add response validation!
        return account_block_template_1.AccountBlockTemplate.callContract(address_1.sentinelAddress, token_standard_1.znnZts, ethers_1.ethers.BigNumber.from("0"), definitions_1.Definitions.common.encodeFunction("CollectReward", []));
    }
    ...
    async withdrawQsr() {
        // ToDo: Add response validation!
        return account_block_template_1.AccountBlockTemplate.callContract(address_1.sentinelAddress, token_standard_1.znnZts, ethers_1.ethers.BigNumber.from("0"), definitions_1.Definitions.common.encodeFunction("WithdrawQsr", []));
    }
}
