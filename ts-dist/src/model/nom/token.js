...
class Token {
    ...
    static fromJson(json) {
        return new Token(json["name"], json["symbol"], json["domain"], ethers_1.ethers.BigNumber.from(json["totalSupply"]), json["decimals"], address_1.Address.parse(json["owner"]), token_standard_1.TokenStandard.parse(json["tokenStandard"]), ethers_1.ethers.BigNumber.from(json["maxSupply"]), json["isBurnable"], json["isMintable"], json["isUtility"]);
    }
    toJson() {
        return {
            name: this.name,
