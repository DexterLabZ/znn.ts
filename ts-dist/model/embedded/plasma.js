...
class FusionEntryList {
    ...
    static fromJson(json) {
        return new FusionEntryList(ethers_1.ethers.BigNumber.from(json.qsrAmount.toString()), json.count, json.list.map((entry) => FusionEntry.fromJson(entry)));
    }
    toJson() {
        return {
...
class FusionEntry {
    ...
    static fromJson(json) {
        return new FusionEntry(ethers_1.ethers.BigNumber.from(json.qsrAmount.toString()), address_1.Address.parse(json.beneficiary), json.expirationHeight, hash_1.Hash.parse(json.id), json.isRevocable);
    }
    toJson() {
        return {
            qsrAmount: this.qsrAmount.toString(),
...
class PlasmaInfo {
    ...
    static fromJson(json) {
        return new PlasmaInfo(json.currentPlasma, json.maxPlasma, ethers_1.ethers.BigNumber.from(json.qsrAmount.toString()));
    }
    toJson() {
        return {
